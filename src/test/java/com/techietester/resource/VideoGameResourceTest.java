 ...
 * {@link com.techietester.client.HttpClient} which is configured in
 * {@link BaseApiTest}.
 *
...
class VideoGameResourceTest extends BaseApiTest {
    ...
    void ensureTestGameExists() {
        httpClient.delete(VIDEOGAMES_PATH + "/" + TEST_GAME_ID);

        Map<String, Object> body = new VideoGameBuilder().build();  // id=100 by default
        httpClient.post(VIDEOGAMES_PATH, body)
                  .then()
                  .statusCode(200);
    }
    ...
    void getAllVideoGames_returns200AndNonEmptyList() {
        httpClient.get(VIDEOGAMES_PATH)
                  .then()
                  .statusCode(200)
    ...
    void getVideoGameById_returns200AndCorrectGame() {
        httpClient.get(VIDEOGAMES_PATH + "/" + SEEDED_GAME_ID)
                  .then()
                  .statusCode(200)
    ...
    void createVideoGame_returns200AndSuccessMessage() {
        ...
        // Verify the game is actually persisted
        httpClient.get(VIDEOGAMES_PATH + "/101")
                  .then()
                  .statusCode(200)
                  .body("name",        equalTo("New Test Game"))
                  .body("reviewScore", equalTo(92));

        // Cleanup – keep side-effects out of other tests
        httpClient.delete(VIDEOGAMES_PATH + "/101");
    }
    ...
    void updateVideoGame_returns200AndUpdatedFields() {
        ...
        httpClient.put(VIDEOGAMES_PATH + "/" + TEST_GAME_ID, updatedBody)
                  .then()
                  .statusCode(200)
    ...
    void deleteVideoGame_returns200AndSuccessMessage() {
        ...
        httpClient.get(VIDEOGAMES_PATH + "/" + TEST_GAME_ID)
                  .then()
                  .statusCode(not(200));
    }
    ...
    void deleteEvenVideoGames_returns200AndDeletedCount() {
        httpClient.delete(VIDEOGAMES_PATH + "/delete-even")
                  .then()
                  .statusCode(200)
