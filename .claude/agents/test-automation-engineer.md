...
description: >-
  ...
  fix. Should be used for code refactoring and improvements. Performs self-validation (compilation checks).
model: sonnet
color: purple
memory: project
...
skills: component-testing, db-testing
---
...
1. `component-testing` — test structure, naming, AllureSteps, fixture rules, annotations
2. `db-testing` — database interaction patterns
