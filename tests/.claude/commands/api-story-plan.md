---
description: Analyse a Spring Boot JAX-RS endpoint and produce a detailed Jira Story plan
argument-hint: <path-to-endpoint-source-file>
---
...
passed to `/api-story-create` for implementation.

## Inputs

- Endpoint source file: `$ARGUMENTS`
...
- Application config: `app/src/main/resources/application.properties`
...
- Known bugs / missing guards flagged with a warning marker
- REST deviations
...
> - Flag known bugs with `> Known issue` blockquote **below** the AC — never inside the Expected result
...
5. End with a note: _"Review complete. Run `/api-story-create` to create this story in Jira."_
